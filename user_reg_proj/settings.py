"""
Django settings for user_reg_proj project.
...
SECRET_KEY = 'rc=(7v1+8it8gl7p6rn3!qt+wrjx81c1l!#h-nwddpe$imfl4v'
...
ROOT_URLCONF = 'user_reg_proj.urls'
...
WSGI_APPLICATION = 'user_reg_proj.wsgi.application'
